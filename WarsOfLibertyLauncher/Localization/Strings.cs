...
public static class Strings
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Table = new()
    {
        ...
        // ── Rank guide (docs/design_insignias_pantallas_guia, 46a/46b) ──
        ["MpGuideTitle"] = new() { [LangEn] = "Ranks", [LangEs] = "Rangos" },
        ["MpGuideLink"] = new() { [LangEn] = "How ranks work", [LangEs] = "Cómo funcionan los rangos" },
        ["MpGuideClose"] = new() { [LangEn] = "Close", [LangEs] = "Cerrar" },
        ["MpGuideYouAre"] = new() { [LangEn] = "You are {0}", [LangEs] = "Eres {0}" },
        ["MpGuidePlaceOf"] = new() { [LangEn] = "{0} of {1}", [LangEs] = "{0} de {1}" },
        ["MpGuideYouUnknown"] = new() { [LangEn] = "Your place isn't known yet", [LangEs] = "Aún no se conoce tu puesto" },
        ["MpGuideNextPassOne"] = new() { [LangEn] = "Pass 1 player to reach {0}.", [LangEs] = "Adelanta a 1 jugador para llegar a {0}." },
        ["MpGuideNextPassMany"] = new() { [LangEn] = "Pass {0} players to reach {1}.", [LangEs] = "Adelanta a {0} jugadores para llegar a {1}." },
        ["MpGuideNextWho"] = new() { [LangEn] = "{0} is {1}.", [LangEs] = "{0} va {1}." },
        ["MpGuideNextDefend"] = new() { [LangEn] = "You lead the ladder. Defend your place: whoever passes you takes it.", [LangEs] = "Estás arriba del todo. Defiende tu puesto: quien te adelante se lo lleva." },
        ["MpGuideNextPlayFirst"] = new() { [LangEn] = "Play your first competitive match, with Record Game on, to enter the ladder.", [LangEs] = "Juega tu primera partida competitiva, con Record Game activado, para entrar en la clasificación." },
        ["MpGuideAgesTitle"] = new() { [LangEn] = "THE SIX AGES", [LangEs] = "LAS SEIS EDADES" },
        ["MpGuideRangeOne"] = new() { [LangEn] = "{0} place", [LangEs] = "puesto {0}" },
        ["MpGuideRange"] = new() { [LangEn] = "{0} – {1}", [LangEs] = "{0} – {1}" },
        ["MpGuideRangeAndBelow"] = new() { [LangEn] = "{0} and below", [LangEs] = "{0} en adelante" },
        ["MpGuideRangeNone"] = new() { [LangEn] = "nobody yet", [LangEs] = "nadie todavía" },
        ["MpGuideRangeDiscovery"] = new() { [LangEn] = "no decided matches yet", [LangEs] = "sin partidas decididas" },
        ["MpGuideDiscoveryHolders"] = new() { [LangEn] = "Everyone starts here", [LangEs] = "Todos empiezan aquí" },
        ["MpGuidePlayersOne"] = new() { [LangEn] = "1 player", [LangEs] = "1 jugador" },
        ["MpGuidePlayersMany"] = new() { [LangEn] = "{0} players", [LangEs] = "{0} jugadores" },
        ["MpGuideYouAt"] = new() { [LangEn] = "You · {0}", [LangEs] = "Tú · {0}" },
        ["MpGuideHowTitle"] = new() { [LangEn] = "HOW THE RANKING WORKS", [LangEs] = "CÓMO FUNCIONA LA CLASIFICACIÓN" },
        ["MpGuideHow1"] = new() { [LangEn] = "Your age comes from your place in the table, not from your rating. The top tenth are Sovereign, then Imperial, Industrial, Fortress and Colonial. Beat someone above you to move up.", [LangEs] = "Tu edad sale de tu puesto en la tabla, no de tu rating. La décima parte de arriba es Soberano, y después vienen Imperial, Industrial, Fortalezas y Colonial. Gana a alguien de más arriba para subir." },
        ["MpGuideHow2"] = new() { [LangEn] = "The table is ordered by a confirmed rating. With few matches it sits below the number you see, so a new player cannot top the table after one lucky win.", [LangEs] = "La tabla se ordena por un rating confirmado. Con pocas partidas queda por debajo del número que ves, así que un jugador nuevo no puede ponerse primero con una victoria suelta." },
        ["MpGuideHow3"] = new() { [LangEn] = "Only competitive matches with a readable result count. Turn on Record Game before you start.", [LangEs] = "Solo cuentan las partidas competitivas con resultado leído. Activa Record Game antes de empezar." },
