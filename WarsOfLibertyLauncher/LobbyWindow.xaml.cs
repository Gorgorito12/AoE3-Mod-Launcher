...
#pragma warning restore IDE0052
    ...
    /// <summary>
    /// Title-bar minimise. The window is <c>ShowInTaskbar="True"</c>, so a real
    /// <see cref="WindowState.Minimized"/> goes to the Windows taskbar (a normal
    /// taskbar button) — clicking that button restores it. No chromeless desktop
    /// stub, no system menu (that only happened with ShowInTaskbar=False).
    /// </summary>
